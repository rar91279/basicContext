...
exports['default'] = function (e, items) {
	...
	var initItem = function initItem(item, num) {
	...
	var insertIn = function insertIn(elem, html) {
	...
	if (opts.parent == null) insertIn(document.body, render());else insertIn(document.querySelector('.basicContextContainer'), render());

	// Select the newly created context and cache it
	setElem(document.querySelector('.basicContext[data-id=\'' + id + '\']'));

	// Calculate position
	position = (0, _coordinates2['default'])(e, elem);
	...
	items.forEach(function (item, num) {
		...
		var itemElem = elem.querySelector('.basicContext__item[data-num=\'' + num + '\']');
...
var getNormalizeEvent = function getNormalizeEvent(e) {
...
var getBrowserSize = function getBrowserSize() {
...
var getElemSize = function getElemSize(elem) {
...
exports['default'] = function (e, elem) {
	if (e === undefined) e = {};

	var normalizedPosition = getNormalizeEvent(e);
